          ...
          <div class="col-sm-8">
            <div class="shop-menu pull-right">
              <ul class="nav navbar-nav">
                ...
                <li>
                  <router-link to="/Checkout"><i class="fa fa-crosshairs"></i> Checkout </router-link>
                 
                </li>

                <li>
                  <router-link to="/Cart"><i class="fa fa-shopping-cart"></i><sup id="a">{{numInCart}}</sup> Cart </router-link>
                </li>
              ...
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li class="dropdown">
                  ...
                  <router-link to="/Checkout"> Checkout </router-link>
                    ...
                    <li><router-link to="/Cart" >Cart {{numInCart}}</router-link></li>
                    <li>
